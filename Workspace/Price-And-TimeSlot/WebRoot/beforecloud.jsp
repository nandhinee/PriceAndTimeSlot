 	  ...
 	  try
		{
			...
			string="select userid , status from cloudreq where userid='"+userid+"'";
...
<div id="header" align="center">
	...
	<table height="105" width="437" align="center"> 
        			<tr> 
	          			<td align="center" height="75"><FONT color="#0000ff">User ID</FONT></td> 
	          			<td align="center" height="75"><FONT color="#0000ff">Status</FONT></td> 
	...
	<br /><br />
	<br></p>
	<table align="center" width="103" height="48">
        			<tr>
          			<td><a href="cloud.jsp">Click to Go</a></td>
       				 </tr>         		
	          		</table></p></div>

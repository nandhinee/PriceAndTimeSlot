...
<body>
<form name="" action="./adminlogin" method="get" enctype="multipart/form-data" >
<div id="mainbody" >
  <div id="topheader"> <a href="#"><img src="images/logo.jpg" title="Business Company" alt="Business Company" width="194" height="47" border="0" /></a>
    <ul style="background-color: rgb(0, 255, 0);">
      <li class="Home"><font size="4" ><a href="firstpage.jsp">&nbsp; Home</a></font></li>
      <li class="Approve"><font size="4"><a href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Approve &nbsp;&nbsp; <br /></a></font></li>
      <li class=""><font size="4"><a href="#">&nbsp;UserDetails</a></font></li>
      <li class=""><font size="4"><a href="#">&nbsp;&nbsp;&nbsp; RiskMap</a></font></li>
       <li class=""><font size="4"><a href="#">&nbsp; &nbsp; OnlineUser</a></font></li>
    </ul>
  </div>
  <div id="topback">
    <h2>welcome</h2>
    ...
    <div id="leftpan" style="width: 755px; height: 379px" >
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
		...
		<tr>
			...
			<p align="center">
			<p align="center">
			<p align="center"><b><font color="Black" size="4">Admin Login</font>
      </b></p></p></p></td>
		</tr>
		<tr>
			<td><label><font color="Black" size="3">user name</font>:</label></td>
			<td><input type="text" name="name" value=""  /> </td>
		</tr>
		<tr>
			<td><font color="Black" size="3">Password</font>:</td>

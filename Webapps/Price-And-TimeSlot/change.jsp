...
<body>
<form name="" action="./change" method="get" enctype="multipart/form-data" >
<div id="mainbody" >
    ...
    <div id="leftpan" style="width: 755px; height: 379px" >
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
		...
		<tr>
			...
			<p align="center">
			<p align="center">
			<p align="center"><b><font size="4">Request To Users</font>
      </b></p></p></p></td>
		</tr>
		<tr>
			<td><label><font size="4">User Id</font>:</label></td>
			<td><input type="text" name="userid" value=""  /> </td>
		</tr>
		
		<tr>
			<td colspan="2" align="center"><input type="submit" value="SendRequest" /></td>
		</tr>
	</table> </p></div>
  </div>
  <div id="footer">

...
<%! ResultSet rs; String string ,username,pass,type;%>
 <% 
  ...
  %>
<body>
<form name="" action="./accept" method="get" enctype="multipart/form-data" >
<div id="mainbody" >
    ...
    <div id="leftpan" style="width: 755px; height: 379px" >
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
		...
		<table height="70" width="449" align="center"> 
        			<tr> 
	          			<td align="center" height="31"><FONT color="#0000ff">User Name</FONT></td> 
	          			<td align="center" width="116" height="31"><FONT color="#0000ff">Password</FONT></td> 
	          			<td align="center" height="31"><FONT color="#0000ff">Price</FONT></td> 
	          			<td align="center" height="31"><FONT color="#0000ff">Status</FONT></td> 
		...
		<br /><br />
        			...
        			<tr>
        			<td colspan="2" align="center"><font color="Black" size="2">Username :</font></td>
          			<td colspan="2" align="center"><input type="text" name="name" /></td>
       				 </tr> 
       				 <tr>
        			<td colspan="2" align="center"><font color="Black" size="2">Password :</font></td>
